...
function HeroSection() {
  return (
     <div
    className="h-auto md:h-[58rem] w-full dark:bg-dot-white/[0.12] rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0"
    >
